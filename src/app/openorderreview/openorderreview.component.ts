...
@Component({
  selector: 'app-openorderreview',
  templateUrl: './openorderreview.component.html',
  styleUrls: ['./openorderreview.component.css'],
  animations: [
  trigger('listStagger', [
    transition('* <=> *',[
...
export class OpenorderreviewComponent implements OnInit {
...
// Part one of fixing the filtering code -- 6/12/2020
  ...
  compareEtaDates(etadate){
    ...
    if(etaDATE >= new Date()){
       this.notyetarrived = true;
       console.log(this.notyetarrived);
    }
    else{
       this.notyetarrived = false;
       console.log(this.notyetarrived);
    }
