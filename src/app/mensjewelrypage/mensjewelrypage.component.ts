...
@Component({
  selector: 'app-mensjewelrypage',
  templateUrl: './mensjewelrypage.component.html',
  styleUrls: ['./mensjewelrypage.component.css'],
  animations: [
  trigger('listStagger', [
    transition('* <=> *',[
...
export class MensjewelrypageComponent implements OnInit {
  ...
  showPendants: any;
  showNecklaces: any;
  mensjewelryitemarray: any; //copy of orig mens fabrics array
  mensjewelrycategoryvar:any;//heading of each section
  ...
  //Event emitted when the selected value has been changed by the user.
    ...
    ngOnInit()  {
      this.jewelryitemservice.getMensJewelryPage()
          .subscribe((res) =>{
             this.mensjewelryitemarray = res;
             this.overallFilterArray = this.mensjewelryitemarray.slice();
             this.makeeveryitemappear();
             console.log('mens jewelry');
             console.log(this.mensjewelryitemarray);
             console.log(this.mensjewelryitemarray[2]);
    ...
    viewEveryItem(sendarray){ // this function takes every item and turns it into a 2D array with three items per row.
      ...
      async viewCategory(itemstring){
          ...
          const tempmensarray = this.mensjewelryitemarray.slice();
...
/// left off edit here 10:51 am 6/26/2020
    ...
    makeeveryitemappear(){
          this.mensjewelrycategoryvar = "Every Men's Jewelry Item In-Stock";
       ...
       this.viewEveryItem(this.mensjewelryitemarray);

      }

    makeBraceletAppear(){
      this.mensjewelrycategoryvar = "Men's Bracelets";
    ...
    makeEarringsAppear(){
      this.mensjewelrycategoryvar = "Men's Earrings";
      this.viewCategory("earring");

    }

    makeWatchesAppear(){
      this.mensjewelrycategoryvar = "Men's Watches";
    ...
    makeRingsAppear(){
      this.mensjewelrycategoryvar = "Men's Rings";
      this.viewCategory("ring");

    }

    makePendantsAppear(){
      this.mensjewelrycategoryvar = "Men's Pendants";
      this.viewCategory("pendant");

    }

    makeNecklacesAppear(){
      this.mensjewelrycategoryvar = "Men's Necklaces";
