...
var genderfabrics = require('./genderfabrics');
var womengenderfabrics = require('./womengenderfabrics');
var jewelryItems = require('./jewelrygender');
var popartquery = require('./popartquery');
var popbookquery = require('./queryBooks');
var userOrderHub = require('./collectorders');
var userCartHub = require('./obtainsavedcarts');
var itemslikedhub = require('./itemsliked');
var allmensclothing = require('./mensclothing');
var savingcarts = require('./savecart');
var deletingcarts = require('./deleteUserCarts');
var savingorders = require('./saveorder');
var mainjewelrypages = require('./mainjewelrypages');
var artpagequery = require('./artpagequery');
var bookpagequery = require('./bookpagefetch');
var furniturepagequery = require('./furniturefetch');
var likeditemsrecord = require('./likeditemsrecord');
